...
formula <- ond ~ pay +age_group +sex  +duration 
...
Summary: We are unable to fit a log link model with all predictors, because we get the error message:

*Error: no valid set of coefficients has been found: please supply starting values*

If we use more predictors that these:
`r print(formula)`
