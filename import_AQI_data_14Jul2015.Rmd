...
PUF_Q4_2013 <- PUF_Q4_2013[complete.cases(PUF_Q4_2013$asaps_imputed),]

```

It would make sense to try to control for *asaps* or *asaps_imputed*, (ASA Status, which indicates how sick a patient was, and only `r missing` of the remaining cases do not have an ASA status recorded; so we exclude them, leaving us with `r dim(PUF_Q4_2013)[1]` unique cases with also *asaps_imputed* as a predictor.
...
attach(PUF_Q4_2013)
myAQI_4_14 <- data.frame(ondansetron,
                         dexamethason,
                         droperidol,
                         ondan_dex_either,
                         Payment, 
